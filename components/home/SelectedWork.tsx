      ...
      <Container>
        <AnimatedSection className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            <SectionLabel className="mb-6 block text-text-primary">
              SELECTED WORK
            </SectionLabel>
        ...
        <div className="space-y-24 md:space-y-32">
          {caseStudies.slice(0, 2).map((project, idx) => (
            <div
              key={project.client}
              className={`flex flex-col ${idx % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"} gap-8 md:gap-16 group`}
            >
              ...
              <div className="w-full md:w-2/5 flex flex-col justify-center">
                <AnimatedSection delay={0.3}>
                  <div className="text-xs font-bold text-text-muted uppercase tracking-widest mb-3 transition-colors duration-500 group-hover:text-electric">
                    {project.industry}
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.6} className="space-y-6">
                  <div>
                    <h4 className="text-xs font-bold text-navy uppercase tracking-widest mb-2">
                      Services Delivered
                    </h4>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center font-bold text-navy hover:text-electric transition-colors border-b border-navy hover:border-electric pb-1 self-start group/link"
                  >
                    View Case Study{" "}
